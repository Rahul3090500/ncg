    ...
    <Link href={blogUrl} className="group block w-full overflow-hidden bg-transparent cursor-pointer" style={{ perspective: 1000 }}>
      ...
      >
        ...
        <div className="pb-[16px] pt-[20px] relative">
          {/* Date */}
          <p 
            className={`group-hover:text-slate-950 text-white text-xs leading-3 font-manrope-normal mt-2`}
          >
            {formatDate(date)}
          </p>
          ...
          {/* Title */}
          <p 
            className={`mt-[4px] group-hover:text-slate-950 text-white text-lg leading-6`}
          >
            {title}
          </p>
